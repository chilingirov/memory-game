...
View.prototype.updateStars = function(moves) {
    for (var i = 0; i < this.stars.length; i++) {
        if (moves > 30) {
            ...
            this.stars[0].className = "fa fa-star";
            this.stars[1].className = "fa fa-star";
            this.stars[2].className = "fa fa-star";
        }
    }
};
...
function Controller() {
    ...
    this.resetStopTimer = function() {
        clearInterval(tt);
        this.view.timer.innerHTML = "00:00:00";
    };
